...
class ForgottenPassword extends Component {
    ...
    onSubmit=(e)=>{
        ...
        axios.post('http://localhost:5000/etudiant/passwordRecovery',body,config)
        .then(()=>{
            this.setState({
        ...
        return (
            <div style={styling}>
                <Card style={styling.card}>
                    <CardBody >
                        <CardTitle className="text-center"><h5><strong>Etudiant Password Recovery</strong></h5></CardTitle>
                        <hr /><br />
                        ...
                        <CardText className="text-center">
                            ...
                            <Link to="/etudiant/login">Return to login</Link>
                        </CardText>
                    </CardBody>  
                </Card>
            </div>
